...
<form action="/admin/contact" method="post">
    ...
    {{ csrf_field() }}
    <input type="hidden" name="key" value="site.contact">
    <div class="form-group">
        <label class="sr-only" for="display_name">Display name</label>
        <input type="text" class="form-control my-editor" id="display_name" name="display_name" placeholder="Display name" value="{{ $contact->display_name }}">
    </div>
    <div class="form-group">
        <label class="sr-only" for="value">Value</label>
        <textarea class="form-control my-editor" id="value" name="value">{{ $contact->value }}</textarea>
    </div>
